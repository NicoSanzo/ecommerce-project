...
export function UseNavegationBar() {
    ...
    useEffect(() => {
        ...
        setInputSearchValue(''); //si existe la data la guarda en el contexto de busqueda para que en el componente de pagina "productos" muestre el listado de productos que encontro;
